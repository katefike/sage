...
--
-- Name: txn_tag_mapping; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.txn_tag_mapping (
    id integer NOT NULL,
...
ALTER TABLE public.txn_tag_mapping OWNER TO admin;

--
-- Name: txn_tag_mapping_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.txn_tag_mapping ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.txn_tag_mapping_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: txn_tags; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.txn_tags OWNER TO admin;

--
-- Name: txn_tags_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.txn_tags ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.txn_tags_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: txns_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.txns ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.txns_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: txn_tag_mapping txn_tag_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.txn_tag_mapping
    ADD CONSTRAINT txn_tag_mapping_pkey PRIMARY KEY (id);


--
-- Name: txn_tags txn_tags_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.txn_tags
    ADD CONSTRAINT txn_tags_pkey PRIMARY KEY (id);
...
--
-- Name: txn_tag_mapping txn_tag_mapping_txn_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.txn_tag_mapping
    ADD CONSTRAINT txn_tag_mapping_txn_id_fkey FOREIGN KEY (txn_id) REFERENCES public.txns(id);


--
-- Name: txn_tag_mapping txn_tag_mapping_txn_tag_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.txn_tag_mapping
    ADD CONSTRAINT txn_tag_mapping_txn_tag_id_fkey FOREIGN KEY (txn_tag_id) REFERENCES public.txn_tags(id);


--
-- Name: txns txns_bank_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.txns
    ADD CONSTRAINT txns_bank_id_fkey FOREIGN KEY (bank_id) REFERENCES public.banks(id);


--
-- Name: txns txns_email_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.txns
    ADD CONSTRAINT txns_email_id_fkey FOREIGN KEY (email_id) REFERENCES public.emails(id);


--
-- Name: txns txns_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.txns
    ADD CONSTRAINT txns_entity_id_fkey FOREIGN KEY (entity_id) REFERENCES public.entities(id);


--
-- Name: txns txns_identical_txn_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.txns
    ADD CONSTRAINT txns_identical_txn_id_fkey FOREIGN KEY (identical_txn_id) REFERENCES public.txns(id);
...
GRANT SELECT ON TABLE public.banks TO grafanareader;
...
GRANT SELECT ON TABLE public.emails TO grafanareader;
...
GRANT SELECT ON TABLE public.entities TO grafanareader;
...
GRANT SELECT ON TABLE public.entity_tag_mapping TO grafanareader;
...
GRANT SELECT ON TABLE public.entity_tags TO grafanareader;


--
-- Name: TABLE txn_tag_mapping; Type: ACL; Schema: public; Owner: admin
--

GRANT INSERT ON TABLE public.txn_tag_mapping TO etl;
GRANT SELECT ON TABLE public.txn_tag_mapping TO grafanareader;


--
-- Name: TABLE txn_tags; Type: ACL; Schema: public; Owner: admin
--

GRANT INSERT ON TABLE public.txn_tags TO etl;
GRANT SELECT ON TABLE public.txn_tags TO grafanareader;


--
-- Name: TABLE txns; Type: ACL; Schema: public; Owner: admin
--

GRANT INSERT ON TABLE public.txns TO etl;
GRANT SELECT ON TABLE public.txns TO grafanareader;
