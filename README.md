...
5. **WARNING: CREATING DIGITAL OCEAN VOLUMES ALSO COSTS MONEY.** In the Digital Ocean console, go to the "Volumes Block Storage" tab and create two volumes: `sage-db` and `sage-mailserver`.
